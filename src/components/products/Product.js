    ...
    <Card className={darkClasses}>
      ...
      <Card.Body className="d-flex flex-column justify-content-between">
        <Container fluid className="p-0">
          ...
          <Card.Text className="fs-6">{props.description}</Card.Text>
        </Container>

        <Container fluid className="position-relative px-0 border-0">
          <Toast
            show={addedNotification}
            onClose={showNotification}
            className="border-0"
          >
            <Toast.Body className="bg-warning position-absolute w-100 text-center fs-5 rounded">
              Item added to cart!
            </Toast.Body>
          </Toast>
        </Container>
        ...
        <Container fluid className="p-0">
          <Container
            fluid
            className="d-flex flex-column justify-content-between align-items-center p-0 py-2"
          >
            <Container fluid className="p-0 mt-1">
              Rating : &nbsp;
              {[...Array(fullStars)].map((key) => (
            ...
            <Container
              fluid
              className="p-0 mt-1 d-flex justify-content-between align-items-center p-0 py-2"
            >
              <Container fluid className="p-0">
                <del>
                  <h6 className=" m-0">
              ...
              <Container fluid className="p-0">
                <p className="m-0 text-end">
                  In Stock
                  <span className="badge bg-danger mx-1">{props.stock}</span>
                </p>
              </Container>
            </Container>
          </Container>
